...
void setup() {
  ...
  //Set input pins (step_in, dir_in and en_in + LED)
  DDRB =  0b00100000;
  PORTB = 0b00000111;
  
  //Set input pins (step_in_interrupt, A, B). Set output 
  DDRD =  0b00000000;
  PORTD = 0b00110000;
  ...
  PCMSK2 = 0b00110000; //Pin Change Mask Register. Enable Pin change interrupt for PCINT20&PCINT21 (A,B pin)
...
ISR (PCINT2_vect)
{
  ...
  u8 pind = PIND;
  u8 a = pind & 0b00010000;
  u8 b = pind & 0b00100000;
